    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle("A2:$maxColuna"."2")->getFont()
                    ->setSize(14);
                ...
                //settando width das colunas A,B
                $event->sheet->getColumnDimension('A')->setWidth(19);
                $event->sheet->getColumnDimension('B')->setWidth(52);
